...
function Footer() {
    return (
        <footer className="bg-white rounded-3xl border">
            <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8 ">
                ...
                >
                    <strong className="text-xl text-white sm:text-xl"> Make Your Form Move! </strong>

                    <SignInButton>
                        <button className="inline-flex items-center gap-2 rounded-full border border-white bg-white px-8 py-3 text-indigo-600 hover:bg-transparent hover:text-white focus:ring-3 focus:outline-hidden">
                            Lets get started
                            <MoveRightIcon />
                        </button>
                    </SignInButton>
